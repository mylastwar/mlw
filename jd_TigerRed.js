...
newCookie = ''
resMsg = ''
const activeEndTime = '2022/2/1 00:00:00+08:00';//活动结束时间
...
function getUA(){
  ...
  rebateCode = 'SCwhQPl'
  if($.index != 1){
    let arr = [rebateCodes,'SCwhQPl']
    rebateCode = arr[Math.floor(Math.random() * arr.length)] || rebateCode
    if(!rebateCode) rebateCode = 'SCwhQPl'
  }
