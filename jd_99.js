...
9.9大聚惠
2021-9-9 ~ 2021-9-16
https://lzdz1-isv.isvjcloud.com/dingzhi/dz/openCard/activity/1095255?activityId=f7e4d75f22c84cdeba92bf594b02b910
*/
...
!(async () => {
    ...
    for (let i = 0; i < cookiesArr.length; i++) {
        if (cookiesArr[i]) {
            ...
            $.activityUrl = `https://lzdz1-isv.isvjcloud.com/dingzhi/dz/openCard/activity/${$.authorNum}?activityId=${$.activityId}&shareUuid=cecb9973df8b4678bce47f344dc0c33b&adsource=null&shareuserid4minipg=null&shopid=${$.activityShopId}&lng=00.000000&lat=00.000000&sid=&un_area=`
            await member();
            await $.wait(2000)
            if ($.bean > 0) {
...
async function member() {
    ...
    if ($.token) {
        ...
        if ($.secretPin) {
            ...
            if ($.index === 1) {
                await task('dz/openCard/activityContent', `activityId=${$.activityId}&pin=${encodeURIComponent($.secretPin)}&pinImg=&nick=${encodeURIComponent($.pin)}&cjyxPin=&cjhyPin=&shareUuid=cecb9973df8b4678bce47f344dc0c33b`, 0, 1)
            } else {
                await task('dz/openCard/activityContent', `activityId=${$.activityId}&pin=${encodeURIComponent($.secretPin)}&pinImg=&nick=${encodeURIComponent($.pin)}&cjyxPin=&cjhyPin=&shareUuid=cecb9973df8b4678bce47f344dc0c33b`)
            }
